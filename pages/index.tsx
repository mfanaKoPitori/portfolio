...
export default function Home() {
  ...
  return (
    <section className="flex flex-col space-y-2 p-2 bg-gray-100 text-xs w-full sm:w-3/4 md:w-3/5 2xl:w-3/6 justify-self-center min-h-fit h-fit">
      ...
      <main>
        <section className="flex flex-col justify-self-center text-left space-y-2 w-9/11 lg:w-2/3 p-1 px-2 border-2 border-yellow-500/60 rounded-md min-h-80 lg:min-h-100 lag:max-h-dvh">
          <nav>
