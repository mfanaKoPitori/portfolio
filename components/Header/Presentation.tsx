  ...
  return (
    <>
      <header className="flex flex-col justify-center w-full rounded-md space-x-2 space-y-1 items-center px-2">
        ...
        <section
          ...
          >
            <Image
              ...
              className="rounded-full border-2 border-rose-300/40 backdrop-blur-sm shadow-lg pointer-events-none"
              width={60}
              height={60}
              draggable={false}
            />
        ...
        <h1 className="text-sm lg:text-lg font-bold text-center text-rose-300">
          {fullname}
        </h1>
      </header>
    </>
